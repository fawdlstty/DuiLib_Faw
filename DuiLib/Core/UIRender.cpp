...
//		::DeleteObject (hPen);
//#else
		CRenderEngine::DrawRoundRectangle (hDC, rc.left, rc.top, rc.right - rc.left - 1, rc.bottom - rc.top - 1, width, nSize, Gdiplus::Color (dwPenColor),  false, Gdiplus::Color (dwPenColor));
//#endif
	}
