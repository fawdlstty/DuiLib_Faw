...
namespace DuiLib {
	...
	faw::string_t CLabelUI::GetClass () const {
		return _T ("LabelUI");
	}

	LPVOID CLabelUI::GetInterface (faw::string_t pstrName) {
	...
	void CLabelUI::SetAttribute (faw::string_t pstrName, faw::string_t pstrValue) {
	...
	void CLabelUI::SetText (faw::string_t pstrText) {
