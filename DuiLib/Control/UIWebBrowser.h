...
namespace DuiLib {
	...
	public:
		...
		void SetHomePage (faw::string_t lpszUrl);
		faw::string_t GetHomePage ();
		...
		void Navigate2 (faw::string_t lpszUrl);
		void Refresh ();
		void Refresh2 (int Level);
		void GoBack ();
		void GoForward ();
		void NavigateHomePage ();
		void NavigateUrl (faw::string_t lpszUrl);
	...
	protected:
		IWebBrowser2			*m_pWebBrowser2	= nullptr; //浏览器指针
