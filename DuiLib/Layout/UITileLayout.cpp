...
namespace DuiLib {
	...
	faw::string_t CTileLayoutUI::GetClass () const {
		return _T ("TileLayoutUI");
	}

	LPVOID CTileLayoutUI::GetInterface (faw::string_t pstrName) {
	...
	void CTileLayoutUI::SetAttribute (faw::string_t pstrName, faw::string_t pstrValue) {
