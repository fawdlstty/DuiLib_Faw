...
namespace DuiLib {
	...
	//	//		DUITRACE (_T ("无法将 %s 类型对象绑定到 %s 对象上"), obj->GetClassType ().data (), obj->m_ctrl->GetClass ().data ());
	//	//		ASSERT (false);
	//	//	}
	//	//	obj->binded ();
	//	//}
